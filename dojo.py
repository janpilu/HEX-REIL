...
def train_group(src, tgt, board_size):
    ...
    for group in range(20):
        ...
        for path, agent in agent_dict.items():
            ...
            round = 0
            agent_dir = f'./models/{board_size}x{board_size}/{tgt}/{group}/{path.split("/")[-3]}/{path.split("/")[-2]}'
        ...
        src = f"./models/{board_size}x{board_size}/{tgt}/{group}"


train_group("./models/7x7/winner", "dojo", 7)
