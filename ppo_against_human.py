    ...
    while not done:
        ...
        if current_player == 1:  # Human's turn
            ...
            while action not in valid_actions:
                ...
                coordinates = human_input_to_coordinates(user_input) # convert user input to coordinates
                action = env.hex.coordinate_to_scalar(coordinates) # convert coordinates to scalar
        else:
            # AI's turn
            board = env.hex.board
